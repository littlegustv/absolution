...
{
    Cprintf(ch, "-========- Entering EDIT Mode -=========-\n\r");
    Cprintf(ch, "    Type .h on a new line for help\n\r");
    Cprintf(ch, " Terminate with a ~ or @ on a blank line.\n\r");
    Cprintf(ch, "-=======================================-\n\r");
...
{
    Cprintf(ch, "-=======- Entering APPEND Mode -========-\n\r");
    Cprintf(ch, "    Type .h on a new line for help\n\r");
    Cprintf(ch, " Terminate with a ~ or @ on a blank line.\n\r");
    Cprintf(ch, "-=======================================-\n\r");
...
void string_add( CHAR_DATA *ch, char *argument )
{
    ...
    if ( *argument == '.' )
    {
        ...
        if ( !str_cmp( arg1, ".s" ) )
        {
            Cprintf(ch, "String so far:\n\r");
            Cprintf(ch, "%s", *ch->desc->pString);
            return;
        }
        ...
        if ( !str_cmp( arg1, ".r" ) )
        {
            if ( arg2[0] == '\0' )
            {
                Cprintf(ch, "usage:  .r \"old string\" \"new string\"\n\r");
                return;
            }
