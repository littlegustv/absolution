...
/*****************************************************************************
 Name:      flag_list( table, flags/stat )
 Purpose:   Returns string with name(s) of the flags or stat entered.
 Called by: act_olc.c, olc.c, and olc_save.c.
 ****************************************************************************/
char *
flag_list (const struct flag_type *flag_table, int bits)
{
	static char buf[512];
	int flag;
	...
	for (flag = 0; flag_table[flag].bit != -1; flag++)
	{
...
flag_string (const struct flag_type *flag_table, int bits)
{
	...
	for (flag = 0; flag_table[flag].bit != 0; flag++)
	{
